...
time uv run python -m pkevolve.verification.evidence_programming     --config experiments/example_config.yaml     --claim "FES directly inhibits BCR (either through post-translational modification, complex formation, destabilization, or regulation of expression)."     --output-dir results/test_signor_45343     --notebook-path results/test_signor_45343/evidence_report.ipynb
"""
