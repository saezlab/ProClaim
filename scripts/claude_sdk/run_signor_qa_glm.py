...
Usage:
    ...
    uv run python run_signor_qa_glm.py --test-single
    
    # Process first 10 edges per label
    uv run python run_signor_qa_glm.py --max-edges 10
    
    # Process only true_positive edges
    uv run python run_signor_qa_glm.py --label true_positive
    
    # Run specific edge(s) - useful for re-running failed cases
    uv run python run_signor_qa_glm.py --edge CRTC2_AKT1_up-regulates --label true_negative
    uv run python run_signor_qa_glm.py --edge GNAS_ADCY1_up-regulatesactivity --label true_positive
    
    # Run full batch (all edges)
    uv run python run_signor_qa_glm.py
