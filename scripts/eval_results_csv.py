...
Usage
-----
uv run python scripts/eval_results_csv.py results/connectomedb_eval_20260414_160003/results.csv
uv run python scripts/eval_results_csv.py results/connectomedb_eval_20260414_160003/results.csv --save
"""
import argparse
import csv
import json
